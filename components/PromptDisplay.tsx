    ...
    <div className="h-full flex flex-col p-6 glass-panel rounded-2xl overflow-hidden">
      ...
      <div className="flex-grow overflow-y-auto custom-scrollbar space-y-6 pr-2">
        ...
        <div className="space-y-2">
            <div className="text-xs uppercase tracking-wider text-gray-500 font-bold">Visual Description</div>
            <div className="p-4 bg-black/30 rounded-lg border border-gray-800 text-gray-300 text-sm leading-relaxed font-mono whitespace-pre-wrap">
